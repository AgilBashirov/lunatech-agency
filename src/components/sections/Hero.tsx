...
export function Hero() {
  ...
  const scrollHintClass =
    "absolute bottom-[max(2rem,env(safe-area-inset-bottom,0px))] left-1/2 z-[2] flex min-h-[44px] min-w-[44px] -translate-x-1/2 flex-col items-center justify-center gap-2 px-4 py-2 text-[10px] font-mono uppercase tracking-[0.35em] text-text-tertiary transition-colors duration-300 ease-out hover:text-cyan-300/90";
  ...
  return (
    ...
    >
      <div className="hero-static-overlays pointer-events-none absolute inset-0 z-0 opacity-[0.45]">
        {!reduce ? (
          <motion.div
