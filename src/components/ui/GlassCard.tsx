...
export function GlassCard({
  ...
  return (
    <div
      className={cn(
        "glass-card group relative overflow-hidden rounded-2xl border border-[color:var(--card-border)] bg-[var(--card-bg)] p-6 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06)] backdrop-blur-sm md:backdrop-blur-md md:p-8",
        interactive &&
